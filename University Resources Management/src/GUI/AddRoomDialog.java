...
public class AddRoomDialog extends JDialog {
    ...
    private void onOK() {
        if (textField1.getText().isEmpty() || textField2.getText().isEmpty() || comboBox1.getBounds().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Fill All the required Fields!");
            return;
        }
        Room roomData = new Room(textField1.getText(), textField2.getText(), (Integer) spinner1.getValue(), Boolean.parseBoolean((String) comboBox1.getSelectedItem()));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "ADD NEW ROOM", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, 20, panel1.getFont()), new Color(-14800581)));
        ...
        nameteacher.setText("Room Number:");
        ...
        teacherDepartmentLable.setText("Is Lab:");
        ...
        specilizationTeacher.setText("Room Capacity:");
