...
public class UpdateBatchDialog extends JDialog {
    ...
    private JButton fetchBatchDataButton;
    private JTextField textField2;
    private JSpinner spinner1;
    private JSpinner spinner2;
    Batch batch = new Batch();

    public UpdateBatchDialog() {

        Styling.styleButton(buttonOK, "#059669", "#047857");
        Styling.styleButton(buttonCancel, "#738599", "#6A7584");
        Styling.styleButton(fetchBatchDataButton, "#2563EB", "#1D4ED8");
        ...
        fetchBatchDataButton.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
                batch.FetchBatchInfo(textField1, textField2, spinner2, spinner1);
            }
        });
    }
    ...
    private void onOK() {
        ...
        Batch batchData = new Batch(textField1.getText(), textField2.getText(), (Integer) spinner2.getValue(), (Integer) spinner1.getValue());
        CRUDOperations<Batch> batch = new BatchDAO();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "UDPATE A BATCH", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, 20, panel1.getFont()), new Color(-14800581)));
        ...
        teacherDepartmentLable.setText("Batch Name:");
        ...
        specilizationTeacher.setText("Strength:");
        ...
        emailteacherlable.setText("Semester:");
        ...
        fetchBatchDataButton = new JButton();
        fetchBatchDataButton.setBackground(new Color(-12877066));
        fetchBatchDataButton.setForeground(new Color(-1));
        fetchBatchDataButton.setText("Fetch Batch Data");
        panel2.add(fetchBatchDataButton, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setForeground(new Color(-10193781));
        label1.setText("Batch Found/Not");
        ...
        panel2.add(spinner1, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        spinner2 = new JSpinner();
        spinner2.setBackground(new Color(-1));
        spinner2.setForeground(new Color(-10193781));
        panel2.add(spinner2, new GridConstraints(1, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
