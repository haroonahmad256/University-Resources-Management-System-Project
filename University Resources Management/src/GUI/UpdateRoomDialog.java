...
public class UpdateRoomDialog extends JDialog {
    ...
    private JButton fetchRoomDataButton;
    ...
    public UpdateRoomDialog() {
        ...
        Styling.styleButton(fetchRoomDataButton, "#2563EB", "#1D4ED8");
        ...
        fetchRoomDataButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                room.FetchRoomInfo(textField1, roomNumber, spinner1, comboBox1);
            }
        });
    }

    private void onOK() {
        if (textField1.getText().isEmpty() || roomNumber.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Fill All the required Fields!");
            return;
        }
        Room roomData = new Room(textField1.getText(), roomNumber.getText(), (Integer) spinner1.getValue(), Boolean.parseBoolean((String) comboBox1.getSelectedItem()));
        CRUDOperations<Room> room = new RoomDAO();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "UDPATE A ROOM", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, 20, panel1.getFont()), new Color(-14800581)));
        final JPanel panel2 = new JPanel();
        panel2.setLayout(new GridLayoutManager(3, 4, new Insets(0, 0, 0, 0), 15, 20));
        ...
        teacherIdLabel.setText("Room ID:");
        ...
        teacherDepartmentLable.setText("Room Numer:");
        ...
        specilizationTeacher.setText("Capacity:");
        ...
        emailteacherlable.setText("Is Lab:");
        ...
        fetchRoomDataButton = new JButton();
        fetchRoomDataButton.setBackground(new Color(-12877066));
        fetchRoomDataButton.setForeground(new Color(-1));
        fetchRoomDataButton.setText("Fetch Room Data");
        panel2.add(fetchRoomDataButton, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        status = new JLabel();
        status.setForeground(new Color(-10193781));
        status.setText("Room Found/Not");
        panel2.add(status, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        roomNumber.setAlignmentY(1.0f);
        roomNumber.setBackground(new Color(-1));
        roomNumber.setForeground(new Color(-10193781));
        panel2.add(roomNumber, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
